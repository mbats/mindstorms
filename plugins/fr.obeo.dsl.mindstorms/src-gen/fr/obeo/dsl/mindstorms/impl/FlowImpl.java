 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.mindstorms.impl.FlowImpl#getBlocks <em>Blocks</em>}</li>
 *   <li>{@link fr.obeo.dsl.mindstorms.impl.FlowImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FlowImpl extends BlockImpl implements Flow {
	...
	protected EClass eStaticClass() {
		return MindstormsPackage.Literals.FLOW;
	}
	...
	public EList<Block> getBlocks() {
		if (blocks == null) {
			blocks = new EObjectContainmentEList<Block>(Block.class, this, MindstormsPackage.FLOW__BLOCKS);
		}
		return blocks;
	}
	...
	public NotificationChain basicSetCondition(Condition newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MindstormsPackage.FLOW__CONDITION, oldCondition, newCondition);
	...
	public void setCondition(Condition newCondition) {
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MindstormsPackage.FLOW__CONDITION, null, msgs);
			if (newCondition != null)
				msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MindstormsPackage.FLOW__CONDITION, null, msgs);
			msgs = basicSetCondition(newCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindstormsPackage.FLOW__CONDITION, newCondition, newCondition));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BlockContainer.class) {
			switch (derivedFeatureID) {
				case MindstormsPackage.FLOW__BLOCKS: return MindstormsPackage.BLOCK_CONTAINER__BLOCKS;
				default: return -1;
			}
		}
