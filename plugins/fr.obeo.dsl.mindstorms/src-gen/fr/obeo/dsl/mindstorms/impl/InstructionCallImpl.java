 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.mindstorms.impl.InstructionCallImpl#getInstruction <em>Instruction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstructionCallImpl extends MinimalEObjectImpl.Container implements InstructionCall {
	...
	protected EClass eStaticClass() {
		return MindstormsPackage.Literals.INSTRUCTION_CALL;
	}
		...
		if (instruction != null && instruction.eIsProxy()) {
			...
			if (instruction != oldInstruction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MindstormsPackage.INSTRUCTION_CALL__INSTRUCTION, oldInstruction, instruction));
			}
		}
		return instruction;
	}
	...
	public void setInstruction(Instruction newInstruction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindstormsPackage.INSTRUCTION_CALL__INSTRUCTION, oldInstruction, instruction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MindstormsPackage.INSTRUCTION_CALL__INSTRUCTION:
