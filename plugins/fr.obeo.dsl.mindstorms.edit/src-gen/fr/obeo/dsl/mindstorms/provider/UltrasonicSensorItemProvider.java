...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.mindstorms.UltrasonicSensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UltrasonicSensorItemProvider extends SensorItemProvider {
	 ...
	 * @generated
	 */
	public UltrasonicSensorItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UltrasonicSensor_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UltrasonicSensor_operator_feature", "_UI_UltrasonicSensor_type"),
				 MindstormsPackage.Literals.ULTRASONIC_SENSOR__OPERATOR,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UltrasonicSensor_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UltrasonicSensor_value_feature", "_UI_UltrasonicSensor_type"),
				 MindstormsPackage.Literals.ULTRASONIC_SENSOR__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	/**
	 * This returns UltrasonicSensor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((UltrasonicSensor)object).getName();
