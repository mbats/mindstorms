...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.mindstorms.Delay} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DelayItemProvider extends ActionItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Delay_ms_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Delay_ms_feature", "_UI_Delay_type"),
				 MindstormsPackage.Literals.DELAY__MS,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Delay.class)) {
			case MindstormsPackage.DELAY__MS:
