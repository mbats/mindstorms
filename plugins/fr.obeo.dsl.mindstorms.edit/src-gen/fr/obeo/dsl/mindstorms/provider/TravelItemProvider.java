...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.mindstorms.Travel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TravelItemProvider extends ActionItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Travel_cm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Travel_cm_feature", "_UI_Travel_type"),
				 MindstormsPackage.Literals.TRAVEL__CM,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Travel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Travel_type") :
			getString("_UI_Travel_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Travel.class)) {
			case MindstormsPackage.TRAVEL__CM:
